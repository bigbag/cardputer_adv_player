...
- Native tests use Unity and `UNIT_TEST`.
  The native environment includes path utilities, audio DSP, MP3 metadata, and both decoder sources.
  MP3 tests run the real decoder with native file adapters.
